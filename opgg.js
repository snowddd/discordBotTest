...
client.on('message', msg => {
    ...
    if (msg.content === 'sett' || msg.content === '賽特' ) {
        msg.reply('https://www.op.gg/champion/sett/statistics/top')
    }
    if (msg.content === 'alistar' || msg.content === '牛' || msg.content === '亞歷斯塔') {
        msg.reply('https://www.op.gg/champion/alistar/statistics/support')
    }
    ...
    if (msg.content === 'corki' || msg.content === '飛機' || msg.content === '庫奇') {
        msg.reply('https://www.op.gg/champion/corki/statistics/mid')
    }
    ...
    if (msg.content === 'ornn' || msg.content === '鄂爾' || msg.content === '22') {
    ...
    if (msg.content === 'diana' || msg.content === '黛安娜' || msg.content === '月女') {
